        ...
        var core = {
            ...
            leftPanel: function (element) {
                ...
                var ganttLeftPanel = $('<div class="leftPanel"/>')
                    .append($('<div class="row spacer"/><table style="width: 100%; margin-top: 70px"><tr style="background-color:#f6f6f6;"><td width="20px" style="border-top:1px solid #ddd; border-right: 1px solid #ddd; text-align:center; padding: 3px; background-color: rgba(227, 240, 240, 0.89);"">#</td><td width="90px" style="border-top:1px solid #ddd; border-right: 1px solid #ddd; padding: 0px 1px 1px 10px">N° Equipo</td><td width="290px" style="border-top:1px solid #ddd; border-right: 1px solid #ddd; padding-left: 10px">Descripcion</td><td width="510px" style="border-top:1px solid #ddd; border-right: 1px solid #ddd; padding-left: 10px">Mantenimiento</td><td width="250px" style="border-top:1px solid #ddd; border-right: 1px solid #ddd; padding-left: 10px">Tipo Mantenimiento</td><td width="310px" style="border-top:1px solid #ddd; border-right: 1px solid #ddd; padding-left: 10px">Grupo Trabajo</td></tr></table>')
                         .css("height", "24px")
            ...
            navigateTo: function (element, val) {
                ...
                switch (val) {
                    case "begin":
                        ...
                        break;
                    case "end":
                        var mLeft = dataPanelWidth - rightPanelWidth - 420;
