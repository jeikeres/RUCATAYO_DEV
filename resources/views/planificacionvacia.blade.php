...
<!-- FORMULARIO INGRESO ACTIVO =============================================================================== -->
			  	 		...
			  	 		{!! Form::open(['route' => 'planificacion.actividad','method' => 'POST','class' => 'form-signin', "id"=>"formulario"]) !!}
						    ...
						    <input class="form-control" id="exampleInputEmail1" value="" name="cod_equipo" placeholder="Ej: ABCD0001" style="width: 50%;" maxlength="15" required>
						</div>

						<div class="form-group">
						    <label for="exampleInputPassword1">Descripción de Mantenimiento</label>
						    <input class="form-control" name="desc_mantt" value="" placeholder="Ej: Cambio de Carcaza" maxlength="50" required>
						</div>
		           ...
		           {!! Form::select('tipomantt', $tipo_mtto , null , ['class' => 'form-control' , "style" => "width:50%;" ]) !!}
						...
						<div class="form-group">
						    ...
						    <input class="form-control" id="exampleInputEmail1" value="" name="frecuencia" placeholder="Ej: 30" style="width: 50%;" maxlength="5" required>
              ...
              <input  style="width:47.5%;" type="date" value="" class="form-control" name="mantt_ejec" required>
